...
with open(FILE_NAME_APPENDED_WORDS, encoding='utf8') as words_file:
...
def sort_words_file():
    with open(FILE_NAME_WORDS, encoding='utf8') as file:
        words = [word for word in sorted(file.readlines())]

    with open(FILE_NAME_WORDS, 'w', encoding='utf8') as file:
        file.write(''.join(words))


def sort_appended_words_file():
    with open(FILE_NAME_APPENDED_WORDS, encoding='utf8') as file:
...
def append_words_to_file():
    with open(FILE_NAME_WORDS, 'a', encoding='utf8') as file, \
            open(FILE_NAME_APPENDED_WORDS, encoding='utf8') as appended_words_file:
